        ...
        <table class="table" v-if="store.requests">
          ...
          <tr class="body-tr"
            ...
            <td class="text-xs text-center">
              <span class="font-mono text-green-600" v-if="request.responseCode.Int32 == 200 ||  request.responseCode.Int32 == 202 || request.responseCode.Int32 == 204">{{request.responseCode.Int32}}</span>
    ...
    <div class="flex">
      <div class="w-full">
        <div class="flex" v-if="limit == store.requests?.length || page > 1">
          ...
          <button v-if="limit == store.requests?.length" class="pagination-button" @click="next">Next <i class="fa-solid fa-arrow-right"></i></button>
